...
import static com.vn.pom.commonPage.CommonPageConstants.HOMEPAGE_DISPLAY_FAILURE_MSG;
import static com.vn.pom.commonPage.CommonPageConstants.INT_TEN;
...
public class HomePageHelper extends AbstractBasePage {
    ...
    public void waitForLoadingIconIsComplete() {
        try {
            LOGGER.info("Wait until loading icon completes loading");
            waitForElementNotVisibleWithCustomTimeout(homePageLocators.loadingIcon, INT_TEN);
